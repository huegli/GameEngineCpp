...
class Registry
{
  ...
  public:
    ...
    ~Registry() { Logger::Log("Registry descructor called"); }
...
template <typename TComponent> void Entity::RemoveComponent() { registry->RemoveComponent<TComponent>(*this); }

template <typename TComponent> bool Entity::HasComponent() { return registry->HasComponent<TComponent>(*this); }
